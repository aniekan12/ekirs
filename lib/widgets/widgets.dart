...
InputDecoration buildDecorations(Color _purple, double _textFieldBorderWidth,
    double _textSize, String hint, bool obscure,
...
//labelText: 'Email',
    ...
    errorBorder: OutlineInputBorder(
      ...
      borderSide:
          BorderSide(color: buttonColorTwo, width: _textFieldBorderWidth),
    ),
    border: OutlineInputBorder(
        /*borderRadius: BorderRadius.only(
            topLeft: Radius.circular(8), bottomRight: Radius.circular(8)),*/
        borderSide: BorderSide(
            color: buttonColorTwo, //_purple,
